...
import {atualizarSubCategoriaComVerificacao } from '../../../../BASEDEDADOS/sub_categorias';
...
const ModalAguardeAtualizar: React.FC<Props> = ({ visivel, cor, icone, categoriaId, nomeCategoria, setVisivel,idSubcategoria }) => {
    ...
    const processarCriacao = async () => {
        ...
        const resultado = await Promise.all([
            atualizarSubCategoriaComVerificacao(idSubcategoria, nomeCategoria, icone, cor, categoriaId),
            delay,
          ]).then(([res]) => res);
            ...
            <View style={styles.modal}>
                ...
                {etapa === 'carregando' && (
                    <>
                        ...
                        <Text style={styles.texto}>Atualizando a categoria...</Text>
                ...
                {etapa === 'sucesso' && (
                    <>
                        ...
                        <Text style={styles.nome}>{nomeCategoria}</Text>
                        <Text style={styles.texto}>Categoria atualizada com sucesso!</Text>
                ...
                {etapa === 'erro' && (
                    <>
                        ...
                        <Text style={styles.nome}>Erro ao atualizar</Text>
...
export default ModalAguardeAtualizar;
