...
const ModalOpcoesCamera: React.FC<Props> = ({ visivel, aoFechar, onAbrirGaleria, onInserirManual }) => {
    return (
        <Modal
            isVisible={visivel}
        ...
        >
            <View style={styles.modalBox}>
                <Text style={styles.titulo}>Opções da Câmara</Text>
                ...
                <TouchableOpacity style={styles.botaoManual} onPress={onInserirManual}>
                    ...
                    <Text style={styles.textoBotaoBranco}>Inserir Manualmente</Text>
                </TouchableOpacity>
...
export default ModalOpcoesCamera;
