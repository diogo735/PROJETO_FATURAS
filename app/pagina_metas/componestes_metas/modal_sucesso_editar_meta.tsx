...
const ModalAguardeEditarMeta: React.FC<Props> = ({ visivel, iniciarProcesso, nomeMeta, setVisivel,cor,nome_subcat,img_cat,icone_nome }) => {
            ...
            <View style={styles.modal}>
                ...
                {etapa === 'carregando' && (
                    <>
                        ...
                        <Text style={styles.texto}>Atualizando a meta...</Text>
                ...
                {etapa === 'sucesso' && (
                    <>
                        ...
                        <Text style={styles.nome}>{nomeMeta}</Text>
                        <Text style={styles.texto}>Meta atualizada com sucesso!</Text>
...
export default ModalAguardeEditarMeta;
